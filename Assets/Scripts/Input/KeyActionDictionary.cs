...
{
    readonly Dictionary<KeyCode, Action<InputState>> legacyInputActions = new();
    readonly Dictionary<string, Action<InputState>> inputSystemActions = new();
    ...
    void Check(KeyCode keycode, Action<InputState> action)
    {
    ...
    void Check(string key, Action<InputState> action)
    {
